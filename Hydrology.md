...
-   `r pkg("hydrocan"): hydrocan provides unified access to Canadian hydrometric data from diverse web-published sources.
	hydrocan adds provincial and utility networks data sources that have no existing R package.
